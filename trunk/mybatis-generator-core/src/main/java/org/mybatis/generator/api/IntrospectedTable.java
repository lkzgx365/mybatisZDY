...
public abstract class IntrospectedTable {
     ...
     * 自定义语句
     */
    public String getSelectListByConditionStatementId() {
    ...
    protected enum InternalAttribute {
         ...
         * 自定义条件查询集合
         */
        ATTR_SELECT_LIST_BY_CONDITION_ID,

        /**
         * 自定义条件查询总数
         */
        ATTR_SELECT_COUNT_BY_CONDITION_ID,

        /**
         * 自定义业务逻辑编号更新
         */
        ATTR_UPDATE_BY_BUSINESS_CODE_ID,

        /**
         *自定义业务逻辑编号查询单条
         */
        ATTR_SELECT_BY_BUSINESS_CODE_ID
    }
}
